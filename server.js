...
const ATUALIZAR_CADA_MINUTOS = 5;
...
app.get("/", (req, res) => {
  res.json({
    status: "online",
    mensagem: "API de Coleta de Clientes - MeggaPainel",
    endpoints: {
      "/clientes": "Retorna dados dos clientes",
      "/status": "Status do cache",
      "/atualizar": "Força nova coleta",
      "/clientes-app": "Dados formatados para app",
      "/limpar-cache": "Limpa e regenera cache"
    }
  });
});
